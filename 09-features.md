...
| 100/101 | `option_gossip_set_reconciliation` | Node can receive gossip minisketch packets            | IN       |                   | [BOLT #7][bolt07-set-reconciliation] |
...
[bolt07-set-reconciliation]: 07-routing-gossip.md#set-reconciliation
